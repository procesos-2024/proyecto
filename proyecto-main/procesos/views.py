...
def marcar_venta_pagada(request, venta_id):
    ...
    for detalle in detalles:
        ...
        if articulos.stock < detalle.cantidad:
            return render(request, 'error_stock.html', {'Articulo': articulos})

    # Si hay stock suficiente, continuar con el proceso
    venta.pagada = True
    venta.save()
    ...
    for detalle in detalles:
        articulos = detalle.articulos
        articulos.stock -= detalle.cantidad
        articulos.save()
